import { a, F as c, r as H, g as i, f as l, d as m, h as o, x as p, b as r, z as S, w as s, e as t, t as u, u as x } from './index-CgZSobh0.js'; import { s as _ } from './index-CyRf_8z7.js'; import { _ as g } from './index-DCXHaOxe.js'

const T = { class: 'w-flex justify-end gap2' }; const A = { __name: 'schedules', setup(C) {
  const h = x(); const w = [{ start: '2018-10-30 10:30', end: '2018-10-30 11:30', title: 'Doctor appointment', content: '<i class="w-icon mdi mdi-hospital-box-outline"></i>', class: 'health', schedule: 1 }, { start: '2018-11-16 10:30', end: '2018-11-16 11:30', title: 'Doctor appointment', content: '<i class="w-icon mdi mdi-hospital-box-outline"></i>', class: 'health', schedule: 1 }, { start: '2018-11-19 10:35', end: '2018-11-19 11:30', title: 'Doctor appointment', content: '<i class="w-icon mdi mdi-hospital-box-outline"></i>', class: 'health', schedule: 1 }, { start: '2018-11-19 18:30', end: '2018-11-19 19:15', title: 'Dentist appointment', content: '<i class="w-icon mdi mdi-hospital-box-outline"></i>', class: 'health', schedule: 2 }, { start: '2018-11-20 18:30', end: '2018-11-20 20:30', title: 'Cross-fit', content: '<i class="w-icon mdi mdi-dumbbell"></i>', class: 'sport', schedule: 2 }, { start: '2018-11-21 11:00', end: '2018-11-21 13:00', title: 'Brunch with Jane', content: '<i class="w-icon mdi mdi-coffee-outline"></i>', class: 'leisure', schedule: 1, background: !1 }, { start: '2018-11-21 19:30', end: '2018-11-21 23:00', title: 'Swimming lesson', content: '<i class="w-icon mdi mdi-pool"></i>', class: 'sport', schedule: 2 }, { start: '2018-11-23 12:30', end: '2018-11-23 13:00', title: 'Macca\'s with Mark', content: '<i class="w-icon mdi mdi-food"></i>', class: 'leisure', schedule: 2 }, { start: '2018-11-23 21:00', end: '2018-11-23 23:30', title: 'Movie time', content: '<i class="w-icon mdi mdi-ticket"></i>', class: 'leisure', schedule: 1 }, { start: '2018-11-30 21:00', end: '2018-11-30 23:30', title: 'Another movie tonight', content: '<i class="w-icon mdi mdi-ticket"></i>', class: 'leisure', schedule: 1 }]; const n = p({ doctorHours: { mon: { from: 480, to: 1020, class: 'doctor-1', label: '<strong>Doctor 1</strong><br><em>Full day shift</em>' }, tue: { from: 540, to: 1080, class: 'doctor-2', label: '<strong>Doctor 2</strong><br><em>Full day shift</em>' }, wed: [{ from: 480, to: 720, class: 'doctor-1', label: '<strong>Doctor 1</strong><br><em>Morning shift</em>' }, { from: 840, to: 1140, class: 'doctor-3', label: '<strong>Doctor 3</strong><br><em>Afternoon shift</em>' }], thu: { from: 480, to: 1020, class: 'doctor-1', label: '<strong>Doctor 1</strong><br><em>Full day shift</em>' }, fri: { from: 540, to: 1080, class: 'doctor-3', label: '<strong>Doctor 3</strong><br><em>Full day shift</em>' }, sat: { from: 540, to: 1080, class: 'doctor-2', label: '<strong>Doctor 2</strong><br><em>Full day shift</em>' }, sun: { from: 420, to: 1200, class: 'closed', label: '<strong>Closed</strong>' } }, simpleBusinessHours: { mon: { from: 540, to: 1080, class: 'business-hours' }, tue: { from: 540, to: 1080, class: 'business-hours' }, wed: [{ from: 540, to: 720, class: 'business-hours' }, { from: 840, to: 1080, class: 'business-hours' }], thu: { from: 540, to: 1080, class: 'business-hours' }, fri: { from: 540, to: 1080, class: 'business-hours' } }, choices: [{ value: 'simpleBusinessHours', label: 'Simple Business Hours' }, { value: 'doctorHours', label: 'Doctor\'s Hours' }], businessHoursType: H('simpleBusinessHours') }); const d = p({ minCellWidth: 400, minScheduleWidth: 0, schedules: [{ id: 1, class: 'mom', label: 'Mom' }, { id: 2, class: 'dad', label: 'Dad', hide: !1 }, { id: 3, class: 'kid1', label: 'Kid 1' }, { id: 4, class: 'kid2', label: 'Kid 2' }, { id: 5, class: 'kid3', label: 'Kid 3' }], scheduleEvents: [...w.map(b => ({ ...b })), { start: '2018-11-21 12:00', end: '2018-11-21 12:30', title: 'Recall Dave', content: '<i class="w-icon mdi mdi-coffee-outline"></i>', class: 'leisure', schedule: 1 }, { start: '2018-11-21 20:00', end: '2018-11-21 22:00', title: 'Salsa', content: '<i class="w-icon mdi mdi-walk"></i>', class: 'sport', schedule: 1 }, { start: '2018-11-23 21:00', end: '2018-11-23 23:30', title: 'Movie time', content: '<i class="w-icon mdi mdi-ticket"></i>', class: 'leisure', schedule: 2 }] }); return (b, e) => {
    const v = a('w-icon'); const k = a('w-radios'); const f = a('example'); const y = a('alert'); return m(), r(c, null, [l(f, { title: 'Special Hours (or Business Hours)', anchor: 'special-hours' }, S({ 'desc': s(() => [e[2] || (e[2] = t('div', { class: 'todo-tag d-iflex' }, 'MAKE THIS INTERACTIVE', -1)), e[3] || (e[3] = t('p', null, [o('The special hours are visible on '), t('span', { class: 'code' }, 'week'), o(' and '), t('span', { class: 'code' }, 'day'), o(` views and allow
...
/>`, -1))]), 'code-css': s(() => [n.businessHoursType === 'doctorHours'
      ? (m(), r(c, { key: 0 }, [o(`.vuecal__special-hours {
  text-align: center;
  ...
  em {
    ...
    line-height: 1.15;
      ...
      : (m(), r(c, { key: 1 }, [o('.business-hours {background-color: #00daff21;}')], 64))]), 'default': s(() => [l(i(g), { 'dark': i(h).darkMode, 'views': ['day', 'week'], 'time-from': 420, 'time-to': 1200, 'special-hours': n[n.businessHoursType], 'style': { height: '550px' } }, null, 8, ['dark', 'special-hours'])]), '_': 2 }, [n.businessHoursType === 'simpleBusinessHours'
      ? { name: 'code-js', fn: s(() => [e[6] || (e[6] = o(`const specialHours = {
  ...
  fri: { from: 9 * 60, to: 18 * 60, class: 'business-hours' }
      ...
      : n.businessHoursType === 'doctorHours'
        ? { name: 'code-js', fn: s(() => [e[7] || (e[7] = o(`const specialHours = {
  mon: {
    from: 8 * 60,
    to: 17 * 60,
    class: 'doctor-1',
