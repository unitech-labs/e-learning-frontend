...
`, -1))])]), _: 1 }), l(b, { title: 'Events & Background Events', anchor: 'events' }, { 'desc': s(() => [e[27] || (e[27] = n('p', null, [t('Events are defined by a '), n('code', null, 'start'), t(' and '), n('code', null, 'end'), t(` dates, provided as a JavaScript Date object
...
`)])], -1)), n('div', J, [l(g, { 'modelValue': y.showBgEvents, 'onUpdate:modelValue': e[0] || (e[0] = o => y.showBgEvents = o) }, { default: s(() => [...e[26] || (e[26] = [t('Show Background Events', -1)])]), _: 1 }, 8, ['modelValue'])])]), 'code-html': s(() => [...e[29] || (e[29] = [t('<vue-cal :events="events" />', -1)])]), 'code-js': s(() => [e[30] || (e[30] = t(`const events = [
  {
...
`, -1)])]), 'default': s(() => [l(d(k), { 'class': 'ex--open-dialog-on-event-click', 'events': c.events, 'time-from': 540, 'time-to': 900, 'views': { days: { cols: 5, rows: 1 } }, 'view': 'days', 'views-bar': !1, 'dark': d(D).darkMode, 'onEventClick': c.openDialog }, null, 8, ['events', 'dark', 'onEventClick'])]), '_': 1 }), c.event
      ? (r(), F(T, { 'key': 0, 'modelValue': c.showDialog, 'onUpdate:modelValue': e[2] || (e[2] = o => c.showDialog = o), 'title': c.event.title, 'width': '380' }, { default: s(() => [n('div', Y, [l(M, { class: 'grey' }, { default: s(() => [...e[38] || (e[38] = [t('mdi mdi-calendar', -1)])]), _: 1 }), n('small', null, i(c.event.start.format()), 1), l(M, { class: 'grey ml2' }, { default: s(() => [...e[39] || (e[39] = [t('mdi mdi-clock-outline', -1)])]), _: 1 }), n('small', null, `${i(c.event.start.formatTime())} - ${i(c.event.end.formatTime())}`, 1)]), n('div', { class: 'w-flex align-center justify-center title1 mt6 mb4', innerHTML: c.event.content }, null, 8, G), e[40] || (e[40] = n('p', { class: 'lh1' }, `Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil inventore expedita veniam deleniti,
labore corporis quas, aspernatur praesentium quia nisi, omnis quod autem.
`, -1))]), _: 1 }, 8, ['modelValue', 'title']))
      : A('', !0), l(b, { title: 'Month View Events & Count', anchor: 'events-on-month-view' }, { 'desc': s(() => [n('ul', null, [e[44] || (e[44] = n('li', null, [t('When '), n('code', null, 'events-on-month-view'), t(` is set to true, the events will show in full on the month view
...
`, -1)), l(z, { to: '/examples/customization#ex--events-on-month-view' }, { default: s(() => [...e[41] || (e[41] = [t('Events on Month View Customization', -1)])]), _: 1 }), e[43] || (e[43] = t(`.
`, -1))])]), n('div', R, [l(g, { 'modelValue': a.showEvents, 'onUpdate:modelValue': [e[3] || (e[3] = o => a.showEvents = o), e[4] || (e[4] = o => a.showEvents && (a.showEventCount = !1))], 'label-on-left': '' }, { default: s(() => [...e[47] || (e[47] = [t('Show Events', -1)])]), _: 1 }, 8, ['modelValue']), l(g, { 'modelValue': a.showEventCount, 'onUpdate:modelValue': [e[5] || (e[5] = o => a.showEventCount = o), e[6] || (e[6] = o => a.showEventCount && (a.showEvents = !1))], 'label-on-left': '' }, { default: s(() => [...e[48] || (e[48] = [t('Show Event Count', -1)])]), _: 1 }, 8, ['modelValue']), l(j, { 'modelValue': a.eventCountStyle, 'onUpdate:modelValue': e[7] || (e[7] = o => a.eventCountStyle = o), 'inline': '', 'items': a.eventCountStyleOptions, 'disabled': !a.showEventCount }, { default: s(() => [...e[49] || (e[49] = [t('Events Count Style', -1)])]), _: 1 }, 8, ['modelValue', 'items', 'disabled']), e[51] || (e[51] = n('p', { class: 'caption' }, 'For illustration, the slot option will only count orange events (with the `leisure` class).', -1)), l(g, { 'modelValue': a.highlightCells, 'onUpdate:modelValue': e[8] || (e[8] = o => a.highlightCells = o), 'label-on-left': '' }, { default: s(() => [...e[50] || (e[50] = [t('Highlight Cells with Events', -1)])]), _: 1 }, 8, ['modelValue'])])]), 'code-html': s(() => [t(`<vue-cal
...
`, 1), a.showEventCount && a.eventCountStyle === 'slot'
      ? (r(), v(p, { key: 0 }, [t(`
...
<template #event-count="{ events }">
  <span v-if="events.filter(event => event.class === 'leisure').length">
    ${i('{{ events.filter(event => event.class === \'leisure\').length }}')}
      ...
      : (r(), v(p, { key: 1 }, [], 64))]), 'code-css': s(() => [e[52] || (e[52] = t(`.vuecal {
  height: 506px;
...
`, -1)), a.showEventCount
      ? a.eventCountStyle === 'dot'
        ? (r(), v(p, { key: 1 }, [t(`  .event-count--dot .vuecal__cell-events-count {
    position: absolute;
    bottom: 14px;
    right: 15%;
...
`)], 64))
        : a.eventCountStyle === 'dash'
          ? (r(), v(p, { key: 2 }, [t(`  .event-count--dash .vuecal__cell-events-count {
    position: absolute;
    top: 24px;
    right: 12px;
    text-align: center;
...
`)], 64))
          : a.eventCountStyle === 'caption'
            ? (r(), v(p, { key: 3 }, [t(`  .event-count--caption .vuecal__cell-events-count {
    position: absolute;
    inset: auto 2px 2px;
    text-align: center;
    opacity: 0.3;
...
`)], 64))
            : (r(), v(p, { key: 4 }, [], 64))
      : (r(), v(p, { key: 0 }, [], 64)), a.highlightCells
      ? (r(), v(p, { key: 5 }, [t(`  .vuecal__cell--has-events {background-color: ${i(d(D).darkMode ? '#00dbff1c' : '#fffacda8')};}
`, 1)], 64))
      : (r(), v(p, { key: 6 }, [], 64)), e[53] || (e[53] = t('}', -1))]), 'default': s(() => [l(d(k), { 'events': C, 'events-on-month-view': a.showEvents, 'event-count': a.showEventCount, 'time-from': 480, 'time-to': 1080, 'views': { days: { cols: 5, rows: 1 }, month: {}, year: {} }, 'view': 'month', 'dark': d(D).darkMode, 'class': N(a.classes), 'style': { height: '506px' } }, q({ _: 2 }, [a.showEventCount && a.eventCountStyle === 'slot' ? { name: 'event-count', fn: s(({ events: o }) => [o.filter(H => H.class === 'leisure').length ? (r(), v('span', X, i(o.filter(H => H.class === 'leisure').length), 1)) : A('', !0)]), key: '0' } : void 0]), 1032, ['events-on-month-view', 'event-count', 'dark', 'class'])]), '_': 1 }), l(b, { title: 'Overlapping Events', anchor: 'overlapping-events' }, { 'desc': s(() => [e[56] || (e[56] = n('p', null, [t('Overlapping, editable & deletable events.'), n('br'), t(`
...
Example of classes for three overlapping events: `), n('code', null, 'vuecal__event--stack-1-3'), t(', '), n('code', null, 'vuecal__event--stack-2-3'), t(', '), n('code', null, 'vuecal__event--stack-3-3'), t('.')], -1)), l(U, { 'src': '/images/calendar-events-display-overlapping-events.webp', 'lazy': '', 'aspect-ratio': 1076 / 336, 'max-width': '500px' })]), _: 1 }), n('div', $, [l(g, { 'modelValue': E.stackEvents, 'onUpdate:modelValue': e[9] || (e[9] = o => E.stackEvents = o), 'label-on-left': '' }, { default: s(() => [...e[55] || (e[55] = [t('Stack Events', -1)])]), _: 1 }, 8, ['modelValue'])])]), 'code-html': s(() => [t(`<vue-cal
...
})`, -1)])]), 'default': s(() => [l(d(k), { 'view': 'days', 'views': { day: {}, days: { cols: 5, rows: 1 }, week: {}, month: {} }, 'dark': d(D).darkMode, 'events-count-on-year-view': '', 'editable-events': { resizeX: !0 }, 'events': B.events, 'onReady': e[12] || (e[12] = ({ view: o }) => o.scrollToCurrentTime()), 'style': { height: '506px' } }, null, 8, ['dark', 'events'])]), '_': 1 })], 64)
  }
