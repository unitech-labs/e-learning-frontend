...
const handleSubmit = async () => {
  try {
    ...
    const response = await gradeEssay(gradingId, formData)
  ...
  <div class="p-6">
    ...
    <div class="mb-6">
      <div class="flex items-center gap-4 mb-4">
        ...
        <div>
          <h1 class="text-2xl font-bold text-gray-900">Chấm điểm bài tự luận</h1>
          <p class="text-gray-600">Đánh giá và phản hồi cho bài làm của học sinh</p>
        </div>
      </div>
    </div>
    ...
    <div v-else-if="essayGrading" class="space-y-6">
      <!-- Student Info -->
      ...
      <!-- Question -->
      <div class="bg-white rounded-lg shadow-sm border p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Câu hỏi</h3>
        <div class="bg-gray-50 border border-gray-200 p-4 rounded-lg">
          <p class="text-gray-900 whitespace-pre-wrap">{{ essayGrading.question_prompt }}</p>
        </div>
      </div>

      <!-- Student Answer -->
      <div class="bg-white rounded-lg shadow-sm border p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Câu trả lời của học sinh</h3>
        <div class="bg-blue-50 border border-blue-200 p-4 rounded-lg">
          <p class="text-gray-900 whitespace-pre-wrap">{{ essayGrading.student_answer_text }}</p>
        </div>
      </div>

      <!-- Grading Form -->
      <div class="bg-white rounded-lg shadow-sm border p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Chấm điểm</h3>
        ...
        >
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- Score Preview -->
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Xem trước điểm</label>
              <div class="bg-gray-50 border border-gray-200 p-4 rounded-lg">
                <div class="text-center">
                  <div class="text-2xl font-bold text-gray-900">{{ formData.score }}/{{ maxScore }}</div>
                  <div class="text-sm text-gray-600">
                    <span :class="{
          ...
          <!-- Feedback -->
          <a-form-item label="Phản hồi cho học sinh" name="feedback" class="mt-6">
            <a-textarea
