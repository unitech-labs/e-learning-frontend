  ...
  <div class="flex p-8 flex-col">
    ...
    <div v-else-if="!currentCourse" class="flex flex-col items-center justify-center min-h-[400px]">
      <div class="text-center">
        ...
        <h2 class="text-2xl font-bold text-gray-700 mb-2">Course Not Found</h2>
        <p class="text-gray-500 mb-6">The course you're looking for doesn't exist or has been removed.</p>
